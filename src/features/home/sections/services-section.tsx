  ...
  return (
    <Section id="services" background="muted">
      <Container>
        ...
        <div className="grid h-[300px] md:h-[340px] lg:h-[400px] lg:grid-cols-3 gap-4 md:gap-6">
          {SERVICES.map((service, index) => {
            ...
            return (
              <AnimateOnScroll key={service.id} delay={index * 0.08}>
                <article
                  className={cn(
                    "group relative flex h-[340px] md:h-[380px] lg:h-[400px] flex-col rounded-2xl border border-border bg-white p-5 md:p-7 transition-all duration-300 hover:-translate-y-2 hover:border-primary/30 hover:shadow-[0_20px_60px_rgba(37,99,235,0.18)]"
                  )}
                >
